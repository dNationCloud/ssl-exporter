...
{{- define "ssl-exporter.configMapName" -}}
{{- default (include "ssl-exporter.fullname" .) .Values.configMapName }}
{{- end }}

{{- define "ssl-exporter.serviceMonitorLabels" -}}
{{- if .Values.serviceMonitor.releaseLabel }}
release: {{ .Release.Name }}
{{- end }}
{{- if .Values.serviceMonitor.extraLabels }}
{{- toYaml .Values.serviceMonitor.extraLabels }}
{{- end }}
{{- end }}
